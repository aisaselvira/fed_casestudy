...
const Hero = () => {
  return (
    <div className="bg-dark text-white pt-10 pb-20 px-6">
      <div className="container mx-auto flex justify-between items-center">
        <div>
          <Header />
          <h1 className="text-4xl md:text-6xl font-montserrat font-bold mt-10">
            CASE STUDY FED - MSIB ARKATAMA
          </h1>
          <p className="text-sm font-inter mt-4 max-w-lg">
